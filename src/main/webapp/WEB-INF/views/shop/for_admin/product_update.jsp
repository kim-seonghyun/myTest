...
<div style="margin: auto; width: 400px;">
    <div class="p-2">
        <h1 class="h3 mb-3 fw-normal">product update</h1>
        <form action="/admin/productUpdate.do" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" id="productId" name="productId" value="<%=products.getProductId()%>">
            <div class="form-floating mb-3">
            ...
            <div class="form-floating mb-3">
                <input type="text" value="<%=products.getProductImage()%>" class="form-control" readonly>
                <input type="file" id="productImage" name="productImage" placeholder="product Image Update"
                       class="form-control">
                <label for="productImage">상품 이미지</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" id="unitCost" name="unitCost" value="<%=products.getUnitCost()%>"
                       class="form-control"
