...
public class ApplicationListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        User admin = new User("admin", "admin", "12345", "123456", Auth.ROLE_ADMIN, 1_000_000, LocalDateTime.now(),
                null);

        User user = new User("user", "user", "12345", "123456", Auth.ROLE_USER, 1_000_000, LocalDateTime.now(),
                null);
